...
const baseTileVariants = cva(
  ...
  ],
  {
    variants: {
      ...
      interactive: {
        none: "",
        hover: "hover:scale-[1.02] hover:border-btc-primary/20 hover:shadow-glow",
        clickable: "hover:scale-[1.02] hover:border-btc-primary/30 hover:shadow-glow cursor-pointer active:scale-[0.98] transition-transform"
      }
    },
    defaultVariants: {
      size: "md",
