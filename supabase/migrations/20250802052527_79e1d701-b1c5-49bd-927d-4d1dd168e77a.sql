...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_market_indicators_timestamp 
ON market_indicators (timestamp DESC);

CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_engine_outputs_calculated_at 
ON engine_outputs (calculated_at DESC);

CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_master_signals_created_at 
