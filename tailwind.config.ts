	...
	theme: {
		...
		extend: {
			colors: {
				...
				// Terminal Neon Colors - Complete Implementation
			...
			keyframes: {
				...
				'terminal-glow': {
					'0%': { boxShadow: '0 0 10px hsl(var(--neon-teal) / 0.3)' },
					'100%': { boxShadow: '0 0 20px hsl(var(--neon-teal) / 0.6)' }
				},
				'terminal-pulse': {
					'0%, 100%': { opacity: '1' },
					'50%': { opacity: '0.8' }
			...
			animation: {
				...
				'terminal-pulse': 'terminal-pulse 1.5s ease-in-out infinite',
